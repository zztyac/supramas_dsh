...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  supramasLiterature: 'supramas.md',
  supramasPaperIngest: 'supramas.md',
  ...
  supramas: 'supramas.md',
  supramasArtifacts: 'supramas.md',
  supramasController: 'supramas.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  AcquiredPaper: 'supramas.md',
  CreateRunRequest: 'supramas.md',
  ...
  LiteratureIndexProvider: 'supramas.md',
  LiteratureSearchRequest: 'supramas.md',
  LiteratureSearchResult: 'supramas.md',
  PaperArtifact: 'supramas.md',
  PaperArtifactMetadata: 'supramas.md',
  PaperAcquisitionProvider: 'supramas.md',
  PaperImportRequest: 'supramas.md',
  PaperImportSummary: 'supramas.md',
  ResolvedLiteratureCandidate: 'supramas.md',
  RunRef: 'supramas.md',
  RunSnapshot: 'supramas.md',
  SourceType: 'supramas.md',
  Stage1BuilderSubmission: 'supramas.md',
  Stage1ArtifactManifest: 'supramas.md',
  Stage1OutputName: 'supramas.md',
  Stage1OutputStatus: 'supramas.md',
  Stage1ReviewSubmission: 'supramas.md',
  Stage1RunState: 'supramas.md',
  Stage1WorkflowConfig: 'supramas.md',
  SupraMasCreateStage1RequestV1: 'supramas.md',
  SupraMasArtifactContentV1: 'supramas.md',
  SupraMasArtifactsViewV1: 'supramas.md',
  SupraMasEdgeTypeV1: 'supramas.md',
  SupraMasEvidenceChunkSummaryV1: 'supramas.md',
  SupraMasEvidenceRefV1: 'supramas.md',
  SupraMasEvidenceSliceViewV1: 'supramas.md',
  SupraMasLimitationRecordV1: 'supramas.md',
  SupraMasOutputFileV1: 'supramas.md',
  SupraMasOutputNameV1: 'supramas.md',
  SupraMasPaperEvidenceViewV1: 'supramas.md',
  SupraMasRunIdBrand: 'supramas.md',
  SupraMasRunListV1: 'supramas.md',
  SupraMasRunViewV1: 'supramas.md',
  SupraMasSourceTypeV1: 'supramas.md',
  SupraMasStrategyRecordV1: 'supramas.md',
  SupraMasStrategyTreeViewV1: 'supramas.md',
  SupraMasTreeEdgeV1: 'supramas.md',
  SupraMasTreeNodeV1: 'supramas.md',
  SupraMasTuningDimensionV1: 'supramas.md',
  TransitionRunRequest: 'supramas.md',
  Agent: 'core.md',
