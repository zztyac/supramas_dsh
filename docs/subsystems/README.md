...
| [supramas.md](supramas.md) | the material-science extension seam: durable runs, provenance-bound evidence, Stage 1 builder/reviewer workflow, task Remote API, and browser projection |
